...
## 업데이트
### macOS
Homebrew로 `cvtr`을 설치했다면, 새로운 버전이 출시되었을 때 쉽게 업그레이드할 수 있습니다.
...
### 그 외 운영체제
그 외 다른 운영체제의 경우, `cvtr`의 [GitHub Releases 페이지](https://github.com/chebread/cvtr/releases)에서 새로운 버전을 다운로드해야 합니다.
